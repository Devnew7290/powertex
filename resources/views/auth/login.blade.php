            ...
            <div class="block xl:grid grid-cols-2 gap-4">
                ...
                <div class="hidden xl:flex flex-col min-h-screen">
                    <a href="" class="-intro-x flex items-center pt-5">
                        ...
                        <span class="text-white text-lg ml-3"> POWERTEX </span> 
                    </a>
                    <div class="my-auto">
                ...
                <div class="h-screen xl:h-auto flex py-5 xl:py-0 my-10 xl:my-0">
                 ...
                 @csrf
                    <h2 class="intro-x font-bold text-2xl xl:text-3xl text-center xl:text-left">
                        ...
                        <input type="text" class="intro-x login__input form-control py-3 px-4 block @error('email') is-invalid @enderror" id="email" name="email" value="{{ old('email') }}" required autocomplete="email" placeholder="Email" autofocus >
                            @error('email')
                            ...
                            <input type="password"  id="password" class="intro-x login__input form-control py-3 px-4 block mt-4 @error('password') is-invalid @enderror" name="password" required autocomplete="current-password" placeholder="Password">
                            @error('password')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="intro-x mt-5 xl:mt-8 text-center xl:text-left">
                            ...
                            <!-- <a href="{{ route('password.request') }}" class="btn btn-outline-secondary py-3 px-4 w-full xl:w-34 mt-3 xl:mt-0 align-top" style="margin-top:2%;">Forget Password</a> -->
