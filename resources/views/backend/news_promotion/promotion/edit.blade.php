    ...
    <div class="content">
        ...
        <div class="intro-y box py-10 sm:py-20 mt-5">
            ...
            <div class="px-5 mt-10">
                <div class="font-medium text-center text-lg">แก้ไข โปรโมชั่น</div>

            </div>
            <form action="{{ url('backend/promotion/update/'.$id) }}" method="post" enctype="multipart/form-data" onSubmit="return checkImage(this)">
                @csrf
                <div class="px-5 sm:px-20 mt-10 pt-10 border-t border-sl ate-200/60 dark:border-darkmode-400">
                    ...
                    <div class="grid grid-cols-12 gap-6 mt-5">
                        ...
                        <div class="mt-2 col-span-12 sm:col-span-6 xl:col-span-6">
                            <img src="{{ asset($data->promotion_image_cover) }}">
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-12 gap-6 mt-5">
                        ...
                        <div class="mt-2 col-span-12 sm:col-span-6 xl:col-span-6">
                            <input type="file" class="form-control" name="promotion_cover" id="promotion_cover">
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-12 gap-6 mt-5">
                        ...
                        <div class="mt-2 col-span-12 sm:col-span-6 xl:col-span-6">
                            <input type="text" class="form-control" name="promotion_topic" id="promotion_topic" value="{{$data->promotion_topic}}" required>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-12 gap-6 mt-5">
                        ...
                        <div class="mt-2 col-span-12 sm:col-span-6 xl:col-span-6">
                            <textarea name="promotion_detail" id="promotion_detail">{{$data->promotion_detail}}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-12 gap-6 mt-5">
                        ...
                        <div class="mt-2 col-span-12 sm:col-span-6 xl:col-span-3">
                            <input type="number" class="form-control" name="promotion_price" id="promotion_price" value="{{$data->promotion_price}}" required>
                        </div>
                        <div class="mt-2 col-span-12 sm:col-span-6 xl:col-span-3">
                            <select name="promotion_type" id="promotion_type" class="form-control">
                                <option value="percent" @if($data->promotion_type == 'percent') selected @endif >เปอร์เซ็นต์</option>
                                <option value="bath" @if($data->promotion_type == 'bath') selected @endif >บาท</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-12 gap-6 mt-5">
                        ...
                        <div class="mt-2 col-span-12 sm:col-span-6 xl:col-span-6">
                            <input type="date" class="form-control" name="promotion_date_start" id="promotion_date_start" value="{{$data->promotion_date_start}}" required>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-12 gap-6 mt-5">
                        ...
                        <div class="mt-2 col-span-12 sm:col-span-6 xl:col-span-6">
                            <input type="date" class="form-control" name="promotion_date_end" id="promotion_date_end" value="{{$data->promotion_date_end}}" required>
                        </div>
                    </div>

                    @php $products = explode(',', $data->promotion_product); @endphp
                    <div class="grid grid-cols-12 gap-6 mt-5">
                        <div class="mt-2 col-span-12 sm:col-span-6 xl:col-span-3">
                            <b><label for="horizontal-form-1" class="form-label "> สินค้าเข้าร่วมโปรโมชั่น </lable></b>
                        </div>
                        <div class="mt-2 col-span-12 sm:col-span-6 xl:col-span-3">
                            <input type="checkbox" name="promotion_product_all" id="promotion_product_all" @if(count($products) == count($product)) checked @endif> สินค้าทั้งหมด
                        </div>
                        <div class="mt-2 col-span-12 sm:col-span-6 xl:col-span-6">
                    ...
                    <div class="grid grid-cols-12 gap-6 mt-5">
                        ...
                        <div class="mt-2 col-span-12 sm:col-span-6 xl:col-span-6">
                            <input type="number" class="form-control" name="promotion_number" id="promotion_number" value="{{ $data->promotion_number }}" required>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-12 gap-6 mt-5">
                        ...
                        <div class="form-check form-switch" style="display: flex; justify-content: center;">
                            <input name="promotion_status" id="promotion_status" class="form-check-input" type="checkbox" @if($data->promotion_status == 'show') checked @endif>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-12 gap-6 mt-5">
                        ...
                        <div class="mt-2 col-span-12 sm:col-span-6 xl:col-span-6">
                            <input type="text" class="form-control" name="promotion_keyword" id="promotion_keyword" value="{{$data->promotion_keyword}}">
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-12 gap-6 mt-5">
                        ...
                        <div class="mt-2 col-span-12 sm:col-span-6 xl:col-span-6">
                            <input type="text" class="form-control" name="promotion_description" id="promotion_description" value="{{$data->promotion_description}}">
                        </div>
                    </div>
