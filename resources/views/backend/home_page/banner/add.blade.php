    ...
    <div class="content">
        ...
        <div class="intro-y box py-10 sm:py-20 mt-5">
            ...
            <div class="px-5 mt-10">
                <div class="font-medium text-center text-lg">เพิ่ม แบนเนอร์</div>

            </div>
            <form action="{{ url('backend/home/banner/create') }}" method="post" enctype="multipart/form-data" onSubmit="return checkImage(this)">
                @csrf
                <div class="px-5 sm:px-20 mt-10 pt-10 border-t border-sl ate-200/60 dark:border-darkmode-400">
                    ...
                    <div class="grid grid-cols-12 gap-6 mt-5">
                        ...
                        <div class="mt-2 col-span-12 sm:col-span-6 xl:col-span-6">
                            <input type="text" class="form-control" name="banener_number" id="banener_number" placeholder="1" value="{{count($bannerAll) + 1}}" required>
                        </div>
                    </div>
